                    ...
                    {isSelectionMode && (
                        <div className="absolute top-0 left-0 right-0 z-20 bg-brand-600 text-white p-2 flex justify-between items-center shadow-md animate-in slide-in-from-top">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button size="sm" className="bg-brand-500 text-white font-black hover:bg-brand-400 py-1 shadow-sm border-none" onClick={() => setIsQuickChartModalOpen(true)} disabled={specificDashboardItems.length === 0}>Visualiser</Button>
