        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm relative">
          {isSelectionMode && (
            <SelectionOverlay
              ...
              onCreateReport={() => {
                ...
                setIsSpecificDashboardModalOpen(true);
              }}
              onCancel={() => {
                setIsSelectionMode(false);
                setSpecificDashboardItems([]);
          ...
          <PivotGrid
            {...{
              ...
              parentRef,
              isSelectionMode,
              isFormattingSelectionMode: !!formattingSelectionRule,
              selectedItems: specificDashboardItems,
              isEditMode,
              sortBy,
              setSortBy,
              sortOrder,
