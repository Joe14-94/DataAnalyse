    ...
    return (
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 flex-shrink-0">
            ...
            <div className="flex flex-wrap gap-3 w-full md:w-auto">
                ...
                <Button variant={isVlookupDrawerOpen ? "primary" : "secondary"} onClick={() => setVlookupDrawerOpen(!isVlookupDrawerOpen)} className="whitespace-nowrap" title="Enrichissement RechercheV"><LinkIcon className="w-4 h-4 md:mr-2" /><span className="hidden md:inline">RechercheV (VLookup)</span></Button>
