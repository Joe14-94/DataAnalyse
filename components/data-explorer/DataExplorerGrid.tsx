...
import { Dataset, CalculatedField } from '../../types/dataset';
...
export const DataExplorerGrid: React.FC<DataExplorerGridProps> = ({
    tableContainerRef, rowVirtualizer, processedRows, displayFields, currentDataset,
            ...
            <table className="w-full divide-y divide-slate-200 border-collapse text-left" style={{ height: rowVirtualizer.getTotalSize(), tableLayout: 'fixed', minWidth: '100%' }}>
                <thead className="bg-slate-50 sticky top-0 z-20 shadow-sm">
                    <tr>
                        ...
                        {(calculatedFields as CalculatedField[] || []).map((cf) => {
