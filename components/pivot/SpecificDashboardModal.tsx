                    ...
                    <div className="w-full md:w-80 border-r border-slate-200 flex flex-col bg-slate-50">
                        <div className="p-4 border-b border-slate-200 bg-white">
                            <Button
                                ...
                                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2 shadow-sm flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
                            ...
                            {items.length === 0 ? (
                                ...
                                items.map((item, idx) => (
                                    <div key={item.id} className="bg-white border border-slate-200 rounded-lg p-3 shadow-sm hover:border-emerald-300 transition-all group relative">
                                        ...
                                        <div className="text-lg font-black text-emerald-600 font-mono mt-1">{item.value}</div>
                                        ...
                                        <div className="absolute -left-3 top-1/2 -translate-y-1/2 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                disabled={idx === 0}
                                                className="bg-white border border-slate-200 rounded-full p-0.5 shadow-sm text-slate-400 hover:text-emerald-600 disabled:opacity-0"
                                            >
