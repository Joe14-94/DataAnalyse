                     ...
                     <div className="space-y-1">
                        {filters.map((f, idx) => (
                           <div key={idx}>
                              ...
                              <select className="w-full text-[10px] border border-slate-200 rounded p-0.5 mt-0.5" value={f.operator || 'in'} onChange={(e) => { const n = [...filters]; n[idx] = { ...n[idx], operator: e.target.value as any }; setFilters(n); }}>
