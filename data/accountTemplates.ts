...
const PCG_ACCOUNTS: AccountData[] = [
  ...
  {
    code: '205',
    label: 'Concessions et droits similaires, brevets, licences',
    nature: 'asset',
    level: 2,
    parentCode: '20',
    isActive: true,
  ...
  {
    code: '2181',
    label: 'Installations générales, agencements',
    nature: 'asset',
    level: 3,
    parentCode: '218',
    isActive: true,
  ...
  {
    code: '2183',
    label: 'Matériel de bureau et informatique',
    nature: 'asset',
    level: 3,
    parentCode: '218',
    isActive: true,
  ...
  {
    code: '4111',
    label: 'Clients - Ventes de biens ou prestations de services',
    nature: 'asset',
    level: 3,
    parentCode: '411',
    isActive: true,
  ...
  {
    code: '624',
    label: 'Transports de biens et transports collectifs du opex',
    nature: 'expense',
    level: 2,
    parentCode: '62',
    isActive: true,
  ...
  {
    code: '631',
    label: 'Impôts, taxes et versements assimilés sur rémunérations',
    nature: 'expense',
    level: 2,
    parentCode: '63',
    isActive: true,
  ...
  {
    code: '7011',
    label: 'Ventes de produits finis en France',
    nature: 'revenue',
    level: 3,
    parentCode: '701',
    isActive: true,
  ...
  {
    code: '7012',
    label: "Ventes de produits finis à l'étranger",
    nature: 'revenue',
    level: 3,
    parentCode: '701',
    isActive: true,
  ...
  {
    code: '7061',
    label: 'Prestations de services en France',
    nature: 'revenue',
    level: 3,
    parentCode: '706',
    isActive: true,
  ...
  {
    code: '7062',
    label: "Prestations de services à l'étranger",
    nature: 'revenue',
    level: 3,
    parentCode: '706',
    isActive: true,
