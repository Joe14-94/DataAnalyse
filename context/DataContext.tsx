...
import { refreshDerivedDatasets } from '../logic/datasetRefresh';
...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const addBatch = useCallback((datasetId: string, date: string, rows: any[]) => {
    ...
    setAllBatches(prevAllBatches => {
        const withNewBatch = [...prevAllBatches, newBatch];
        return refreshDerivedDatasets(datasetId, datasets, withNewBatch, date);
    });
  }, [datasets, batches]);
